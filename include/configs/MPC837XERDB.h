...
/* ENC clock config */
#define CFG_SCCR_ENCCM	2	/* CSB:ENC = 2:1 */
/* USBDR clock config */
#define CFG_SCCR_USBDRCM	2	/* CSB:USBDR = 2:1 */
...
#define CFG_DDRCDR_VALUE	(DDRCDR_ODT | DDRCDR_Q_DRN)
...
#define CFG_DDR_INTERVAL	((1024 << SDRAM_INTERVAL_REFINT_SHIFT) \
				| (0 << SDRAM_INTERVAL_BSTOPRE_SHIFT))
				/* 0x06090100 */
				/* 0x04000000 global auto-precharge mode */
...
#define CFG_DDR_MODE		((0x0406 << SDRAM_MODE_ESD_SHIFT) \
...
#define CFG_MALLOC_LEN		(8 * 1024 * 1024) /* Reserved for malloc */
 ...
 */
#define CONFIG_YAFFS2_NAND
#define CONFIG_YAFFS2
#define CONFIG_CMD_NAND_YAFFS
#define CONFIG_CMD_NAND_YAFFS1
...
#if CFG_NAND
#define CFG_IBAT1L	(CFG_NAND_BASE | BATL_PP_10 | BATL_MEMCOHERENCE)
#define CFG_IBAT1U	(CFG_NAND_BASE | BATU_BL_256M | BATU_VS | BATU_VP)
