...
MPC8377ERDB_config \
MPC8377ERDB_800MHz_config \
MPC8378ERDB_config \
MPC8379ERDB_config \
MPC837XERDB_config \
MPC837XERDB_800MHz_config:     unconfig
	@mkdir -p $(obj)include
	@echo "" >$(obj)include/config.h ; \
	if [ "$(findstring MPC8377ERDB_,$@)" ] ; then \
		echo -n "... PCI-Express Enabled" ; \
		echo "#define CONFIG_PCIE" >>$(obj)include/config.h ; \
	fi ; \
	if [ "$(findstring _800MHz_,$@)" ] ; then\
		echo -n "...800MHz core freq "; \
		echo "#define CONFIG_FREQ_800MHz  1" >>$(obj)include/config.h ; \
	fi ;
